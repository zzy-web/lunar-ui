...
const components = [LuImage, LuVirtualList, LuResult, LuTimeline, LuTimelineItem, LuInputNumber, LuSlider, LuCollapse, LuCollapseItem, LuSteps, LuSegmented, LuTabs, LuBreadcrumb, LuRate, LuButton, LuInput, LuCard, LuDialog, LuForm, LuFormItem, LuTable, LuTableColumn, LuTour, LuCheckbox, LuSwitch, LuTag, LuCalendar, LuSelect, LuRadio, LuRadioGroup, LuAlert, LuEmpty, LuPagination, LuProgress, LuDivider, LuTree, LuTooltip, LuDropdown, LuBadge, LuAvatar, LuSkeleton, LuSkeletonItem, LuUpload]
